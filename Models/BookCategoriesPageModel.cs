...
namespace Butica_Andrei_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Butica_Andrei_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Butica_Andrei_Lab8Context context,
